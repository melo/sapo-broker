package pt.com.builder;

//import pt.com.ObjectUtils;
...
public class ToStringBuilder {
    ...
    public ToStringBuilder append(String fieldName, boolean[] array, boolean fullDetail) {
        style.append(buffer, fieldName, array, toBooleanObject(fullDetail));
        return this;
    }
    ...
    public ToStringBuilder append(String fieldName, Object object, boolean fullDetail) {
        style.append(buffer, fieldName, object, toBooleanObject(fullDetail));
        return this;
    }
    ...
    public ToStringBuilder appendAsObjectToString(Object object) {
    	appendIdentityToString(this.getStringBuilder(), object);
        return this;
    }
    
    private static StringBuilder appendIdentityToString(StringBuilder buffer, Object object) {
        if (object == null) {
            return null;
        }
        if (buffer == null) {
    ...
    private static Boolean toBooleanObject(boolean bool) {
